/*
 * Lectura del sensor Ultrasónico HC-SR04 con el ESP32CAM y MQTT 
 * por: Eduardo Ortega
 * Fecha: 01 de Octubre de 2021
 * 
 * Este programa lee el sensor ultrasónico con la biblioteca Ultrasonic de Eric Simoes  
 * en su versión 3.0.0. Se mezcla con el programa ESP32CAM-MQTT-basic del repositorio de  
 * Código-IoT.
 * 
